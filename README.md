...
| [feature-development](plugins/feature-development/) | End-to-end feature development: frame → explore → plan → implement (TDD) → verify → hand off. Works with plan mode. | 0.4.0 | productivity |
