...
| [code-review](plugins/code-review/) | Outside-in, risk-driven code review. Covers bug fixes, new features, add-ons, extensions, and refinements. Re-review aware, with a single summary comment per PR. | 1.3.0 | productivity |
...
| [feature-development](plugins/feature-development/) | End-to-end feature development: frame → explore → plan → implement (TDD) → verify → hand off. Works with plan mode. | 0.3.0 | productivity |
